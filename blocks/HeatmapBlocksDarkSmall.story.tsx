...
import {
  heatmapSmallBlocksData,
  heatmapSmallSimpleBlocksData
    ...
    <div className="flex flex-col pt-4 pb-4 bg-black rounded-3xl shadow-[11px_21px_3px_rgba(0,0,0,0.06),14px_27px_7px_rgba(0,0,0,0.10),19px_38px_14px_rgba(0,0,0,0.13),27px_54px_27px_rgba(0,0,0,0.16),39px_78px_50px_rgba(0,0,0,0.20),55px_110px_86px_rgba(0,0,0,0.26)] w-[375px] h-[560px] overflow-hidden">
      ...
      <div className="flex w-full h-full pl-2 pr-2">
        ...
        <SequentialLegend
          ...
          className="pl-1 pr-1 mt-8 !h-[130px]"
        />
      </div>
...
export const SimpleCircle = () => {
  return (
    <div className="flex flex-col pt-4 pb-4 bg-black rounded-3xl shadow-[11px_21px_3px_rgba(0,0,0,0.06),14px_27px_7px_rgba(0,0,0,0.10),19px_38px_14px_rgba(0,0,0,0.13),27px_54px_27px_rgba(0,0,0,0.16),39px_78px_50px_rgba(0,0,0,0.20),55px_110px_86px_rgba(0,0,0,0.26)] w-[375px] h-[560px] overflow-hidden">
      ...
      <div className="flex flex-col pl-8 pr-8 pt-4 font-mono divide-y divide-[#262631]">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="flex w-full pb-4 pt-4 items-center gap-2"
            ...
            <HeatmapSeries
              cell={
                <HeatmapCell
                  symbol={(data) => {
                    const rowNumber =
                      heatmapSmallBlocksData?.[0]?.data?.findIndex(
                        (d) => d.key === data?.x
                      );
