...
export const SimpleMulti = () => {
  return (
    <div className="flex flex-col justify-between pt-4 pb-4 bg-white rounded-3xl shadow-[11px_21px_3px_rgba(0,0,0,0.06),14px_27px_7px_rgba(0,0,0,0.10),19px_38px_14px_rgba(0,0,0,0.13),27px_54px_27px_rgba(0,0,0,0.16),39px_78px_50px_rgba(0,0,0,0.20),55px_110px_86px_rgba(0,0,0,0.26)] w-[600px] h-[714px] overflow-hidden">
      ...
      <div className="flex gap-8 w-full pl-8 pr-8 mb-4">
        <div className="flex gap-2 items-center">
          ...
          <span className="text-[#535362] text-xs">XML</span>
        </div>
        <div className="flex gap-2 items-center">
          <div className="w-4 h-4 bg-[#00DCC2]" />
          <span className="text-[#535362] text-xs">JSON</span>
        </div>
        <div className="flex gap-2 items-center">
          <div className="w-4 h-4 bg-[#6C18E8]" />
          <span className="text-[#535362] text-xs">HTTPS</span>
        </div>
        <div className="flex gap-2 items-center">
          <div className="w-4 h-4 bg-[#6C18E8]" />
          <span className="text-[#535362] text-xs">SSH</span>
        </div>
      </div>
      <BarChart
