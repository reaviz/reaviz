...
export default {
  tags: ['skip-snapshot'],
  title: 'Blocks/Funnel Chart/Light/Medium',
        ...
        series={
          <FunnelSeries
            ...
            axis={
              <FunnelAxis
                label={null}
                line={<FunnelAxisLine strokeColor={'#ffffff'} />}
              />
            }
          />
        }
          ...
          <FunnelSeries
            arc={
              <FunnelArc
                colorScheme={['#5B14C5']}
                gradient={null}
                glow={{ blur: 30, color: '#5B14C5' }}
              />
            }
            axis={
              <FunnelAxis
                label={<FunnelAxisLabel fill="#000000" className="font-bold" />}
                line={<FunnelAxisLine strokeColor={'#ffffff'} />}
              />
            }
          />
