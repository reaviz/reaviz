...
export const Stacked = () => {
  return (
    <div className="flex flex-col justify-between pt-4 pb-4 bg-black rounded-3xl shadow-[11px_21px_3px_rgba(0,0,0,0.06),14px_27px_7px_rgba(0,0,0,0.10),19px_38px_14px_rgba(0,0,0,0.13),27px_54px_27px_rgba(0,0,0,0.16),39px_78px_50px_rgba(0,0,0,0.20),55px_110px_86px_rgba(0,0,0,0.26)] w-[800px] h-[800px] overflow-hidden">
      ...
      <div className="flex gap-8 w-full pl-8 pr-8 mb-4">
        <div className="flex gap-2 items-center">
          <div className="w-4 h-4 bg-[#FAE5F6]" />
        ...
        <div className="flex gap-2 items-center">
          <div className="w-4 h-4 bg-[#BB015A]" />
...
export const MultiSeriesSimple = () => {
  return (
    <div className="flex flex-col justify-between pt-4 pb-4 bg-black rounded-3xl shadow-[11px_21px_3px_rgba(0,0,0,0.06),14px_27px_7px_rgba(0,0,0,0.10),19px_38px_14px_rgba(0,0,0,0.13),27px_54px_27px_rgba(0,0,0,0.16),39px_78px_50px_rgba(0,0,0,0.20),55px_110px_86px_rgba(0,0,0,0.26)] w-[800px] h-[800px] overflow-hidden">
      ...
      <div className="flex gap-8 w-full pl-8 pr-8 mb-4">
        <div className="flex gap-2 items-center">
          <div className="w-4 h-4 bg-[#4C86FF]" />
          <span className="text-[#9A9AAF] text-xs">DLP</span>
        </div>
        <div className="flex gap-2 items-center">
          <div className="w-4 h-4 bg-[#40D3F4]" />
          <span className="text-[#9A9AAF] text-xs">Threat Intel</span>
        </div>
        <div className="flex gap-2 items-center">
...
export const LargeDataset = () => {
  return (
    <div className="flex flex-col justify-between pt-4 pb-4 bg-black rounded-3xl shadow-[11px_21px_3px_rgba(0,0,0,0.06),14px_27px_7px_rgba(0,0,0,0.10),19px_38px_14px_rgba(0,0,0,0.13),27px_54px_27px_rgba(0,0,0,0.16),39px_78px_50px_rgba(0,0,0,0.20),55px_110px_86px_rgba(0,0,0,0.26)] w-[800px] h-[800px] overflow-hidden">
      ...
      <div className="grid grid-cols-5 gap-4 w-full pl-8 pr-8 mb-6">
        <div className="flex gap-2 items-center">
          <div className="w-4 h-4 bg-[#D740BE]" />
          <span className="text-[#9A9AAF] text-xs">Series 18</span>
        </div>
        <div className="flex gap-2 items-center">
          <div className="w-4 h-4 bg-[#0D4ED2]" />
          <span className="text-[#9A9AAF] text-xs">Series 19</span>
        </div>
        <div className="flex gap-2 items-center">
          <div className="w-4 h-4 bg-[#DAC5F9]" />
          <span className="text-[#9A9AAF] text-xs">Series 20</span>
        </div>
        <div className="flex gap-2 items-center">
          <div className="w-4 h-4 bg-[#4C86FF]" />
          <span className="text-[#9A9AAF] text-xs">Series 21</span>
        </div>
        <div className="flex gap-2 items-center">
          <div className="w-4 h-4 bg-[#40E5D1]" />
          <span className="text-[#9A9AAF] text-xs">Series 22</span>
        </div>
        <div className="flex gap-2 items-center">
          <div className="w-4 h-4 bg-[#40D3F4]" />
          <span className="text-[#9A9AAF] text-xs">Series 23</span>
        </div>
        <div className="flex gap-2 items-center">
          <div className="w-4 h-4 bg-[#9152EE]" />
          <span className="text-[#9A9AAF] text-xs">Series 24</span>
        </div>
        <div className="flex gap-2 items-center">
          <div className="w-4 h-4 bg-[#A840E8]" />
          <span className="text-[#9A9AAF] text-xs">Series 25</span>
        </div>
      </div>
      <AreaChart
        id="large-dataset"
