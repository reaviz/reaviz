export const lineSingleSeriesSimpleData = [
  { id: '0', key: new Date('2020-02-01T00:00:00.000Z'), data: 2.5 },
  { id: '1', key: new Date('2020-02-02T00:00:00.000Z'), data: 4 },
  { id: '2', key: new Date('2020-02-03T00:00:00.000Z'), data: 4 },
  { id: '3', key: new Date('2020-02-04T00:00:00.000Z'), data: 7 },
  { id: '4', key: new Date('2020-02-05T00:00:00.000Z'), data: 8 },
  { id: '5', key: new Date('2020-02-06T00:00:00.000Z'), data: 7 },
  { id: '6', key: new Date('2020-02-07T00:00:00.000Z'), data: 8 },
  { id: '7', key: new Date('2020-02-08T00:00:00.000Z'), data: 7 },
  { id: '8', key: new Date('2020-02-09T00:00:00.000Z'), data: 7.5 },
  { id: '9', key: new Date('2020-02-10T00:00:00.000Z'), data: 8 },
  { id: '10', key: new Date('2020-02-11T00:00:00.000Z'), data: 11 },
  { id: '11', key: new Date('2020-02-12T00:00:00.000Z'), data: 11 },
  { id: '12', key: new Date('2020-02-13T00:00:00.000Z'), data: 12 }
];

export const lineSingleSeriesInterpolationSmoothData = [
  { id: '0', key: new Date('2020-02-01T00:00:00.000Z'), data: 17.8 },
  { id: '1', key: new Date('2020-02-03T12:00:00.000Z'), data: 6 },
  { id: '2', key: new Date('2020-02-08T00:00:00.000Z'), data: 14 },
  { id: '3', key: new Date('2020-02-10T12:00:00.000Z'), data: 11 },
  { id: '4', key: new Date('2020-02-13T12:00:00.000Z'), data: 18 }
];

export const lineSingleSeriesInterpolationStepData = [
  { id: '0', key: new Date('2020-02-01T00:00:00.000Z'), data: 17.8 },
  { id: '1', key: new Date('2020-02-03T12:00:00.000Z'), data: 4 },
  { id: '2', key: new Date('2020-02-09T00:00:00.000Z'), data: 14 },
  { id: '4', key: new Date('2020-02-12T12:00:00.000Z'), data: 18 }
];
export const lineCircleSeriesV1Data = [
...
export const lineCircleSeriesV2Data = [
...
export const lineCircleSeriesV3Data = [
...
export const lineCircleSeriesShapesData = lineCircleSeriesV1Data;

export const lineGridlineAllData = lineCircleSeriesV1Data;

export const lineGridlineXData = lineCircleSeriesV1Data;

export const lineGridlineYData = lineCircleSeriesV1Data;

export const lineSingleSeriesLargeData = [
  {
    id: '100',
