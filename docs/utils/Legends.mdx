...
import * as DiscreteLegendHorizontalStories from '../../src/common/legends/DiscreteLegend/DiscreteLegendHorizontal.story'
...
<Canvas sourceState="shown" of={DiscreteLegendHorizontalStories._Simple} />
