...
Let's take a minute to walk through the [code](https://github.com/reaviz/reaviz/blob/master/docs/advanced/Radar.tsx) for this chart.

Before we start with the code, let's break this chart down to its core elements.

![breakdown](https://github.com/reaviz/reaviz/blob/master/docs/advanced/breakdown.png)
